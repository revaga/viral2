...
# Optional allowlist (not used to exempt from any rule; high-volume threshold applies to all channels)
CHANNELS_ALLOWLIST = {
    "Yes Theory",
    "Grian",
    "SSSniperWolf",
...
def main():
    ...
    # Channels to remove: hardcoded list + channels with > max_videos videos (no exceptions)
    ...
    mask_high_volume = df["channelTitle"].isin(over_threshold)
    ...
    mask_remove = mask_list | mask_high_volume | mask_official | mask_cat_25 | mask_cat_10
